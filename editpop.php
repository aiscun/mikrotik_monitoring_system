...
$pop = query("SELECT * FROM pop WHERE pop_id='$id'")[0];
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
          ...
          <li class="breadcrumb-item active">Edit POP</li>
        </ol>
         <div class="card mb-3">
          <div class="card-header">
            ...
            <div class="card-body">
                        ...
                        <input type="hidden" name="pop_id" value="<?= $pop["pop_id"]; ?>">
                       
                        <div class="form-group row">
                          <label for="pop_name" class="col-sm-3 col-form-label">POP Name</label>
                          <div class="col-sm-9">
                            <input type="text" name="pop_name" class="form-control" id="pop_name" required value="<?= $pop["pop_name"]; ?>">
                          </div>
                        </div>
                          <div class="form-group row">
                          <label for="pop_address" class="col-sm-3 col-form-label">POP Address</label>
                          <div class="col-sm-9">
                            <input type="text" name="pop_address" class="form-control" id="pop_address" required value="<?= $pop["pop_address"]; ?>">
                          </div>
                        </div>
