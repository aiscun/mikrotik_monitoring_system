...
$pops = query("SELECT * FROM pop");

if (isset($_POST["cari"])) {
  $pop = cari($_POST["keyword"]);
}
         ...
         <div class="card mb-3">
          ...
          <center>
            <i class="fas fa-table"></i>
              <strong>LIST OF POP</strong></center>  
          </div>
            <div class="card-body">
              <button><a href="formspop.php"><i class="fa fa-plus-square"></i></a></button>
                    ...
                    <table class="table table-hover table-bordered" id="dataTable" width="100%" cellpadding="0">
                      <thead>
                        <tr style="background-color: grey">
                          ...
                          <th><center>POP ID</center></th>
                          <th><center>POP NAME</center></th>
                          <th><center>POP ADDRESS</center></th>
                          <!-- <th>Service</th> -->
                        </tr>
                      </thead>
                      <tbody>
                        ...
                        <a href="editpop.php?pop_id=<?= $pop["pop_id"]; ?>" class="tm-product-edit-link">
                           <i class="fa fa-edit tm-product-edit-icon"></i></a>
                        <a href="hapuspop.php?pop_id=<?= $pop["pop_id"]; ?>" onclick="return confirm ('Are you sure to delete this pop?')" class="tm-product-delete-link">
                         <i class="far fa-trash-alt tm-product-delete-icon"></i></a></center>
                          </td>
                          <td><?= $pop["pop_id"]; ?></td>
                          <td><?= $pop["pop_name"]; ?></td>
                          <td><?= $pop["pop_address"]; ?></td>
                        </tr>
