...
$devices = query("SELECT * FROM device");
        ...
        <!-- Breadcrumbs-->
          ...
          <center>
            <i class="fas fa-table"></i>
              <strong>LIST OF DEVICES</strong></center> 
          </div>
            <div class="card-body">
              <button><a href="formdevices.php"><i class="fa fa-plus-square"></i> </a></button>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><center>
                           ...
                           <a href="editdevice.php?device_id=<?= $device["device_id"]; ?>" class="tm-product-edit-link">
                     <i class="fa fa-edit tm-product-edit-icon"></i></a>
                        <a href="hapusdevice.php?device_id=<?= $device["device_id"]; ?>" onclick="return confirm ('Are you sure to delete this device?')" class="tm-product-delete-link">
                        <i class="far fa-trash-alt tm-product-delete-icon"></i></a></center>
                          ...
                          <td><?php echo $device["device_ip_add"]; ?></td>
