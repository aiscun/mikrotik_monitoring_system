...
$device = query("SELECT * FROM device WHERE device_id='$id'")[0];
      ...
      <div class="container-fluid">
         ...
         <div class="card mb-3">
          <div class="card-header">
            <i class="fa fa-edit tm-product-edit-icon"></i>
            Edit Admin Data</div>
            <div class="card-body">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="device_type" class="form-control" id="device_type" required value="<?= $device["device_type"]; ?>">
                          </div>
                        </div>
                          <div class="form-group row">
                          <label for="device_ip" class="col-sm-3 col-form-label">Device Name</label>
                          <div class="col-sm-9">
                            <input type="text" name="device_ip" class="form-control" id="device_ip" required value="<?= $device["device_ip"]; ?>">
                          </div>
                        </div>
                         <div class="form-group row">
                          <label for="device_ip_add" class="col-sm-3 col-form-label">Device IP</label>
                          <div class="col-sm-9">
                            <input type="text" name="device_ip_add" class="form-control" id="device_ip_add" required value="<?= $device["device_ip_add"]; ?>">
                          </div>
                        </div>
