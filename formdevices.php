            ...
            <div class="card-body">
                       <form action="" method="post" enctype="multipart/form-data" class="forms-sample">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="device_ip" class="form-control" id="device_ip" placeholder="Enter Device Name" required="">
                          </div>
                        </div>
                         <div class="form-group row">
                          <label for="device_ip_add" class="col-sm-3 col-form-label">Device IP</label>
                          <div class="col-sm-9">
                            <input type="text" name="device_ip_add" class="form-control" id="device_ip_add" placeholder="Enter Device IP" required="">
                          </div>
                        </div>
