...
if ( !isset($_SESSION["login"]) ){
  ...
  if(isset($_POST['status3'])){
    $customer_id = $_POST['detail_chart3'];
...
ORDER BY date1 DESC, time1 DESC LIMIT 25";
      ...
      <div class="container-fluid">
        <ol class="breadcrumb">
          ...
          $query="SELECT * FROM customer WHERE customer_id='$customer_id'";
                ...
                $name = trim($name, ",");
           ?>
          <li class="breadcrumb-item active"> Last 5 Hours Chart From <?php echo $name;?></li>
        </ol>
      
          <div class="page-wrapper">
            <br />
              <h2 align="center">Last 5 Hours Received Ping to 8.8.8.8</h2>
                <div id="line_chart" style="width: 100%; height: 500px"></div>
          </div>
          <div class="page-wrapper">
            <br />
              <h2 align="center">Last 5 Hours Average Ping to 8.8.8.8</h2>
                <div id="line_chart1" style="width: 100%; height: 500px"></div>
          </div>
          <div class="page-wrapper">
            <br />
              <h2 align="center">Last 5 Hours Received Ping to Gateway</h2>
                <div id="line_chart7" style="width: 100%; height: 500px"></div>
          </div>
          <div class="page-wrapper">
            <br />
              <h2 align="center">Last 5 Hours Average Ping to Gateway</h2>
                <div id="line_chart8" style="width: 100%; height: 500px"></div>
          </div>
          <div class="page-wrapper">
            <br />
              <h2 align="center">Last 5 Hours Received Ping to Server</h2>
                <div id="line_chart9" style="width: 100%; height: 500px"></div>
          </div>
          <div class="page-wrapper">
            <br />
              <h2 align="center">Last 5 Hours Average Ping to Server</h2>
                <div id="line_chart10" style="width: 100%; height: 500px"></div>
          </div>
          <div class="page-wrapper">
            <br />
              <h2 align="center">Last 5 Hours Temperature Condition</h2>
                <div id="line_chart2" style="width: 100%; height: 500px"></div>
          </div>
          <div class="page-wrapper">
            <br />
              <h2 align="center">Last 5 Hours Voltage Condition</h2>
                <div id="line_chart3" style="width: 100%; height: 500px"></div>
          </div>
          <div class="page-wrapper">
            <br />
              <h2 align="center">Last 5 Hours Total User Hotspot Active</h2>
                <div id="line_chart4" style="width: 100%; height: 500px"></div>
          </div>
          <div class="page-wrapper">
            <br />
              <h2 align="center">Last 5 Hours Total IP Pool</h2>
                <div id="line_chart5" style="width: 100%; height: 500px"></div>
          </div>
          <div class="page-wrapper">
            <br />
              <h2 align="center">Last 5 Hours Total IP DHCP</h2>
