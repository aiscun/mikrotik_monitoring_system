  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <form class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
      <a class="nav-item" href="logout.php" color: black data-toggle="modal" data-target="#logoutModal">
        <i class="menu-icon mdi mdi-logout"></i>Logout</a>
    </form>
  </nav>
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            <i class="fas fa-table"></i>
              <strong>LIST OF ADMINS</strong></center>
          </div>
          <div class="card-body">
          <button><a href="formsadmin.php"><i class="fa fa-plus-square"></i></a></button>
          <div class="table-responsive">
            <table class="table table-hover table-bordered" id="dataTable" width="100%" cellpadding="0">
              ...
              <?php foreach ($admins as $admin) : ?>
                <tr>
                  <td><center>
                      <a href="editadmin.php?id=<?= $admin["id"]; ?>" class="tm-product-edit-link">
                      <i class="fa fa-edit tm-product-edit-icon"></i></a>
                      <a href="hapusaccounts.php?id=<?= $admin["id"]; ?>" onclick="return confirm ('Are you sure to delete this admin?')" class="tm-product-delete-link">
