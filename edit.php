...
$cust = query("SELECT * FROM customer WHERE customer_id='$id'")[0];
            ...
            <div class="card-body">
                       <form action="" method="post" enctype="multipart/form-data" class="forms-sample">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="customer_name" class="form-control" id="customer_name" required value="<?= $cust["customer_name"]; ?>">
                          </div>
                        </div>
                          <div class="form-group row">
                          <label for="customer_address" class="col-sm-3 col-form-label">Customer Address</label>
                          <div class="col-sm-9">
                            <input type="text" name="customer_address" class="form-control" id="customer_address" required value="<?= $cust["customer_address"]; ?>">
                          </div>
                        </div>
                          <div class="form-group row">
                          <label for="customer_servie" class="col-sm-3 col-form-label">Customer Service</label>
                          <div class="col-sm-9">
                            <input type="text" name="customer_service" class="form-control" id="customer_service" required value="<?= $cust["customer_service"]; ?>">
                          </div>
                        </div>
