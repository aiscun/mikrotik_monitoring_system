            ...
            <div class="card-body">
                       <form action="" method="post" enctype="multipart/form-data" class="forms-sample">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="customer_id" class="form-control" id="customer_id" placeholder="Enter Customer ID" required="">
                          </div>
                        </div>
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="customer_address" class="form-control" id="customer_address" placeholder="Enter Customer Address" required="">
                          </div>
                        </div>
                          <div class="form-group row">
                          <label for="customer_servie" class="col-sm-3 col-form-label">Customer Service</label>
                          <div class="col-sm-9">
                            <input type="text" name="customer_service" class="form-control" id="customer_service" placeholder="Enter Customer Service" required="">
                          </div>
                        </div>
