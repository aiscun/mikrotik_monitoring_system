  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
          ...
          <li class="breadcrumb-item">
            <a href="pop.php">POPs</a>
          </li>
          <li class="breadcrumb-item active">Add POP</li>
        </ol>
         <div class="card mb-3">
            ...
            <div class="card-body">
                       <form action="" method="post" enctype="multipart/form-data" class="forms-sample">
                        <div class="form-group row">
                          <label for="pop_id" class="col-sm-3 col-form-label">POP ID</label>
                          <div class="col-sm-9">
                            <input type="text" name="pop_id" class="form-control" id="pop_id" placeholder="Enter POP ID" required="">
                          </div>
                        </div>
                        <div class="form-group row">
                          <label for="pop_name" class="col-sm-3 col-form-label">POP Name</label>
                          <div class="col-sm-9">
                            <input type="text" name="pop_name" class="form-control" id="pop_name" placeholder="Enter POP Name" required="">
                          </div>
                        </div>
                          <div class="form-group row">
                          <label for="customer_address" class="col-sm-3 col-form-label">POP Address</label>
                          <div class="col-sm-9">
                            <input type="text" name="pop_address" class="form-control" id="pop_address" placeholder="Enter POP Address" required="">
                          </div>
                        </div>
